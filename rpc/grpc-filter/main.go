...
import (
	...
	. "go-programming/rpc/grpc-filter/service"
...
type myGrpcServer struct{ UnimplementedGreeterServer }

func (s *myGrpcServer) SayHello(_ context.Context, in *HelloRequest) (*HelloReply, error) {
	panic("debug")
